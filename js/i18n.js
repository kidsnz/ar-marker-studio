...
(function (root) {
  ...
  var JA = {
    ...
    'cfg.leveli1': '1（既定）',
    'cfg.uses': 'どこで使う？:',
    'cfg.uPaint': '絵 64インチ・1.5〜2m',
    'cfg.uScreen': 'ラップトップ画面 12cm・30〜50cm',
    'cfg.uSticker': 'ステッカー 4.5cm・20〜30cm',
    'cfg.dist': '見る距離',
    'cfg.dist.sub': '以下の判定は全部この範囲で行う。'
      + 'マーカーがトラッカーにどれだけ大きく写るかは、刷る実寸とこの距離だけで決まる。',
    'cfg.presets': 'よくある実寸:',
