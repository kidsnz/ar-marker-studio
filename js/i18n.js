...
(function (root) {
  ...
  var JA = {
    ...
    'cfg.leveli1': '1（既定）',
    'cfg.uses': 'どこで使う？:',
    'cfg.uPaint': '絵 72インチ・1.5〜2.2m',
    'cfg.uScreen': 'ラップトップ画面 12cm・25〜40cm',
    'cfg.uSticker': 'ステッカー 5.5cm・10〜15cm',
    'cfg.dist': '見る距離',
    'cfg.fillIs': '→ 画面の {near}〜{far}% を占める（画面上 {npx}〜{fpx}px）',
    'cfg.dist.sub': 'トラッカーが実際に見ているのは「画面の何割を占めるか」で、'
      + '距離の横に出している。3つの使い方は同じ場所には来ない。'
      + '絵は画面いっぱい〜はみ出すが、ステッカーやラップトップ画面は1/3〜1/2までしか'
      + '届かない（それ以上寄れない。iPhoneは10cmあたりでピントが合わなくなる）。'
      + 'だから3つ全部をカバーするマーカーは、'
      + '<strong>画面上65px〜230px</strong>の全域で保つ必要がある。',
    'cfg.presets': 'よくある実寸:',
